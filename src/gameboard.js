...
//         }
//       } else {
//         setScore((score) => score - 1); // Allow score to go below 0
//         setTimeout(() => {
//           setCards((cards) =>
...
//   //         }
//   //       } else {
//   //         setScore((score) => Math.max(0, score - 1)); // Subtract 1 point, but don't go below 0
//   //         setTimeout(() => {
//   //           setCards((cards) =>
//   //             cards.map((card, index) =>
//   //               index === firstIndex || index === secondIndex
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="stats">
        <div id="score">
          <div className="circle1"></div>Score: {score}
        </div>
        <div id="Flips">
          <div className="circle2"></div>Flips: {flips}
        </div>
        <div id="timer">
